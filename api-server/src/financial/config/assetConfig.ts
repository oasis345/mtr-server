...
export const CRYPTO_ASSET_CONFIG: AssetServiceConfig = {
  ...
  cacheableDataTypeMap: new Map<MarketDataType, CacheConfig>([
    ...
    [MarketDataType.MOST_ACTIVE, { ttl: CacheTTL.ONE_MINUTE, refreshInterval: CronExpression.EVERY_MINUTE }],
    [MarketDataType.TOP_TRADED, { ttl: CacheTTL.ONE_MINUTE, refreshInterval: CronExpression.EVERY_MINUTE }],
    [MarketDataType.GAINERS, { ttl: CacheTTL.ONE_MINUTE, refreshInterval: CronExpression.EVERY_MINUTE }],
    [MarketDataType.LOSERS, { ttl: CacheTTL.ONE_MINUTE, refreshInterval: CronExpression.EVERY_MINUTE }],
