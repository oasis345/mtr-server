...
export const CRYPTO_ASSET_CONFIG: AssetServiceConfig = {
  ...
  cacheableDataTypeMap: new Map<MarketDataType, CacheConfig>([
    ...
    [MarketDataType.MOST_ACTIVE, { ttl: CacheTTL.TEN_SECONDS, refreshInterval: CronExpression.EVERY_MINUTE }],
    [MarketDataType.TOP_TRADED, { ttl: CacheTTL.TEN_SECONDS, refreshInterval: CronExpression.EVERY_MINUTE }],
    [MarketDataType.GAINERS, { ttl: CacheTTL.TEN_SECONDS, refreshInterval: CronExpression.EVERY_MINUTE }],
    [MarketDataType.LOSERS, { ttl: CacheTTL.TEN_SECONDS, refreshInterval: CronExpression.EVERY_MINUTE }],
  ...
  defaultLimits: new Map<MarketDataType, number>([
    [MarketDataType.MOST_ACTIVE, 200],
    [MarketDataType.TOP_TRADED, 200],
    [MarketDataType.GAINERS, 200],
    [MarketDataType.LOSERS, 200],
...
export const STOCK_ASSET_CONFIG: AssetServiceConfig = {
  ...
  cacheableDataTypeMap: new Map<MarketDataType, CacheConfig>([
    ...
    [
      ...
      { ttl: CacheTTL.TEN_SECONDS, refreshInterval: CronExpression.EVERY_MINUTE, withLogo: true },
    ],
    [
